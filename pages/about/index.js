...
export const aboutData = [
  {
    ...
    info: [
      ...
      },
      {
        ...
        icons: [<DiDotnet key="dotnet" title=".NET" />, <DiNodejs key="nodejs" title="nodejs" />],
      },
      {
        title: 'Databases',
        icons: [<DiMsqlServer key="sqlserver" title="MS SQL" />, <FaDatabase key="cosmos" title="Cosmos" />, <SiMongodb key="mongo" title="Mongo" />],
      },
      {
        title: 'Platforms',
